...
events.push(function() {
	...
	// Show/hide the advanced
	function hideAdvanced() {
<?php
		// This currently looks at all available interfaces. It might be preferable to only look at selected interfaces.
		echo "showadvanced = ($('#global_filter_type').prop('value') == 'none')\n";
		foreach ($available_interfaces as $interface => $name) {
			echo " && $('#inbound_filter_type_{$interface}').prop('value') == 'none'\n";
			echo " && $('#outbound_filter_type_{$interface}').prop('value') == 'none'\n";
		}
		echo ";\n";
?>
...
<?php
	...
	foreach ($available_interfaces as $interface => $name) {
		echo "function hideInterfaceInboundFilter_{$interface}() {";
			echo "hideClass('sh_interface_inbound_filter_none_{$interface}', $('#inbound_filter_type_{$interface}').prop('value') != 'none');";
			echo "hideClass('sh_interface_inbound_filter_allow_{$interface}', $('#inbound_filter_type_{$interface}').prop('value') != 'allow');";
			echo "hideClass('sh_interface_inbound_filter_deny_{$interface}', $('#inbound_filter_type_{$interface}').prop('value') != 'deny');";
			echo "hideClass('sh_interface_inbound_filter_list_{$interface}', $('#inbound_filter_type_{$interface}').prop('value') == 'none');";
		echo "}\n";
	}
	foreach ($available_interfaces as $interface => $name) {
		echo "function hideInterfaceOutboundFilter_{$interface}() {";
			echo "hideClass('sh_interface_outbound_filter_none_{$interface}', $('#outbound_filter_type_{$interface}').prop('value') != 'none');";
			echo "hideClass('sh_interface_outbound_filter_allow_{$interface}', $('#outbound_filter_type_{$interface}').prop('value') != 'allow');";
			echo "hideClass('sh_interface_outbound_filter_deny_{$interface}', $('#outbound_filter_type_{$interface}').prop('value') != 'deny');";
			echo "hideClass('sh_interface_outbound_filter_list_{$interface}', $('#outbound_filter_type_{$interface}').prop('value') == 'none');";
		echo "}\n";
	}
?>
...
<?php
	...
	foreach ($available_interfaces as $interface => $name) {
		echo "$('#inbound_filter_type_{$interface}').change(function() {";
			echo "hideInterfaceInboundFilter_{$interface}();";
			echo "hideAdvanced();";
		echo "});\n";
	}
	foreach ($available_interfaces as $interface => $name) {
		echo "$('#outbound_filter_type_{$interface}').change(function() {";
			echo "hideInterfaceOutboundFilter_{$interface}();";
			echo "hideAdvanced();";
		echo "});\n";
	}
?>
